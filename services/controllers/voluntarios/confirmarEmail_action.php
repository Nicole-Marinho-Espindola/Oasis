<?php
    ...
    require_once includeURL('/services/helpers.php');
    ...
    if (isset($_GET['cd_voluntario'])) {
        ...
        try {
            ...
            if ($select->execute()) {
                ...
                $emailBody = '<html>
                                ...
                                <body>
                                    <div class="container">
                                        ...
                                        <p><a class="button" href="http://localhost/oasis/views/forms/voluntarios/retornoEmail.php?token_email=' . $row['ds_token'] . '&cd_voluntario=' . $id . '">Confirmar E-mail</a></p>
                ...
                clicando no link a seguir:\n\nhttp://localhost/oasis/views/forms/voluntarios/retornoEmail.php?token_email=' . $row['ds_token'] . '&cd_voluntario=' . $id 
