...
<body>
    ...
    <?php
        if (isset($_GET['email_repetido']) && $_GET['email_repetido'] == 'true') {
            echo '<script src="../../../assets/js/alerts.js"></script>';
            echo '<script>alertEmail();</script>';
        }
    ?>
            ...
            <form action="<?= baseUrl('/services/controllers/voluntarios/cadastro_action.php') ?>" method="POST"
                ...
                <div class="section active">
                    ...
                    <div class="redirect-block">
                        ...
                        <span class="redirecionar-login">É uma ONG? <a href="../ongs/cadastro.php" class="purple-link">Cadastre-se aqui</a></span>
                    </div>   
                </div> 
                <div class="section">
                    <div class="form-title">
