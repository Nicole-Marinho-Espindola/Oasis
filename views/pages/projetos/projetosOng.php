...
<body>
    ...
    <div class="modal-window" id="viewModalWindow">
        ...
        <div class="modal-card modal-card-view">
            <div class="card-view-title">
                ...
                <h1 class="view-title">Voluntários que desejam participar</h1>
            </div>
            <div class="table-block">
                <table class="table">
                    ...
                    <tbody>
                        <?php
                        try {
                            // Consulta para obter os voluntários inscritos no projeto específico
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><a class= "link-style-none-green" href="../../../services/controllers/ongs/projetos/excluirInscricao.php?id=<?php echo $id; ?>&id_voluntario=<?php echo $id_voluntario; ?>"><i class="fa-solid fa-trash"></i></td>
                                </tr>
                        <?php
                            }
                        } catch (PDOException $e) {
            ...
            <div class="modal-card-projects">
                ...
                <div class="modal-project-info">
                    ...
                    <div class="info-modal-req ajust">
                        <i class="fa-solid fa-location-dot icon-project icon-modal-color"></i>
                        <input type="text" class="input-requisitos" placeholder="Localização" id="enderecoProjeto" name="enderecoProjeto">
                    </div>
                    <div class="info-modal-req ajust">
                        <i class="fa-solid fa-calendar-days icon-project icon-modal-color"></i>
                        <input type="date" class="input-requisitos" placeholder="Data do projeto" id="dataProjeto" name="dataProjeto">
                    </div>
                </div>
    ...
    <div class="modal-window" id="EditModalWindow">
        <form class="form" action="<?= baseUrl('/services/controllers/ongs/projetos/editarProjeto.php') ?>" enctype="multipart/form-data" method="POST" onsubmit="return validateForm()">
            ...
            <div class="modal-card-projects">
                ...
                <div class="modal-project-info">
                    <div class="info-modal-req">
                        <i class="fa-solid fa-people-group icon-project icon-modal-color"></i>
                        <input type="text" class="input-requisitos" value="<?= $ong ?>" readonly>
                    </div>
                    <div class="info-modal-req ajust">
                        <i class="fa-solid fa-location-dot icon-project icon-modal-color"></i>
                        <input type="text" class="input-requisitos" value="<?= $endereco ?>" id="enderecoProjeto" name="enderecoProjeto">
                    </div>
                    <div class="info-modal-req ajust">
                        <i class="fa-solid fa-calendar-days icon-project icon-modal-color"></i>
                        <input type="date" class="input-requisitos" value="<?= $data ?>" id="dataProjeto" name="dataProjeto">
                    </div>
                </div>
