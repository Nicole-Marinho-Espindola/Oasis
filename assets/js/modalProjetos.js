...
function openSecondModal() {
    ...
    modal.addEventListener('click', (e) => {
        // Evita fechar se clicar dentro da modal, exceto nos botões de ação
        if (e.target.id === 'SecondModalWindow' && !e.target.closest('.small-blocks-section')) {
            modal.classList.remove('open');
        }
    });
}
...
function openModal(button) {
    ...
    if (deleteLink) {
        var deleteUrlProjeto = "../../../services/controllers/ongs/projetos/excluirProjeto.php?cd_projeto=";
    ...
    if (deleteLinkEvento) {
        var deleteUrlEvento = "../../../services/controllers/ongs/eventos/excluirEvento.php?cd_evento=";
